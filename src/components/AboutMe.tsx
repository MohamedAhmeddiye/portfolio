...
const AboutMe: React.FC = () => {
  ...
  <>
    ...
    <br />
    <a href="https://www.mesrs.gov.mr/fr/team/universite-de-nouakchott-alaasriya" target="_blank" className="link">
 ...
 <div>
    <p style={{ color: 'white' }}>Email : <a href="mailto:medKoumba@email.com" className="link">medkoumba@email.com</a></p>
    <p style={{ color: 'white' }}>WhatsApp : <a href="https://wa.me/22244121245" className="link">+222 44 12 12 45</a></p>
    <p style={{ color: 'white' }}>Téléphone : <a href="tel:+22230469186" className="link">+222 30 46 91 86</a></p>
</div>
  ...
  <>
    {paragraph.description}
    <br />
    <a href="https://ww7.meteo-mauritanie.org/fr/?usid=19&utid=19983449443" target="_blank" className="link">
